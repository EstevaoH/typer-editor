...
export function RegisterForm() {
    ...
    async function onSubmit(data: RegisterFormData) {
        ...
        try {
            ...
            if (!response.ok) {
                toast.showToast(`❌ ${result.error || "Erro ao criar conta"}`);
                return;
            }

            toast.showToast("✅ Conta criada com sucesso! Entrando...");
            ...
            console.error(error);
            toast.showToast("❌ Erro inesperado ao criar conta.");
        } finally {
            setIsLoading(false);
        }
    }
        ...
        <>
            <div className="mb-6 text-center">
                <h1 className="text-2xl font-semibold text-zinc-50">
                    Criar conta no Typer Editor
                </h1>
                <p className="mt-1 text-sm text-zinc-400">
                    Sincronize seus documentos com segurança na nuvem.
                </p>
            </div>
            ...
            <div className="relative my-6">
                ...
                <div className="relative flex justify-center text-xs uppercase">
                    <span className="bg-zinc-950/70 px-2 text-zinc-400">
                        Ou continue com
                    </span>
                </div>
            </div>
            ...
            <p className="mt-6 text-center text-sm text-zinc-400">
                ...
                <button
                    ...
                    className="font-medium text-sky-400 hover:text-sky-300 cursor-pointer hover:underline underline-offset-4 transition-colors"
                >
                    Fazer login
                </button>
            </p>

            ...
            <DocumentsProvider>
                <SidebarProvider>
                    <div className="flex h-screen w-full">
                        <AppSidebar className="fixed inset-y-0 left-0 z-20 hidden w-64 border-r bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 sm:block" />
                        <SidebarInset>
